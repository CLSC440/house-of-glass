                                ...
                                <tr>
                                    ...
                                    <React.Fragment key={row.id}>
                                        ...
                                        {row.hasVariants && expandedIds.has(row.id) && (
                                            <tr className="bg-slate-50 border-b border-gray-100 dark:bg-[#121a2d] dark:border-gray-800/50">
                                                <td colSpan="7" className="px-6 py-5">
                                                    <div className="rounded-[1.6rem] border border-slate-200 bg-white p-4 md:p-5 dark:border-white/8 dark:bg-white/[0.02]">
                                                        ...
                                                        <div className="grid gap-3">
                                                            {row.variants.map((v, idx) => (
                                                                <div key={v.id || idx} className="grid gap-3 rounded-[1.15rem] border border-slate-200 bg-slate-50 px-4 py-3 text-sm md:grid-cols-[minmax(0,1.6fr)_minmax(120px,0.8fr)_minmax(120px,0.8fr)_110px_110px_120px] md:items-center dark:border-white/8 dark:bg-[#18223a]">
                                                                    <div className="flex items-center gap-3 min-w-0">
                                                                        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-200 text-slate-500 dark:bg-white/[0.05] dark:text-slate-400">
                                                                            <i className="fa-solid fa-code-branch text-xs"></i>
                                                                        </span>
                                                                        <div className="min-w-0">
                                                                            <p className="truncate font-bold text-slate-900 dark:text-white">{v.name}</p>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {v.retailStock > 0
                                                                            ? <span className="inline-flex min-w-[3.4rem] justify-center rounded-full bg-blue-50 px-3 py-1 text-xs font-black text-blue-700 dark:bg-blue-500/12 dark:text-blue-400">{v.retailStock}</span>
                                                                            : <span className="inline-flex justify-center rounded-full bg-red-50 px-3 py-1 text-[10px] font-black uppercase tracking-wider text-red-600 dark:bg-red-500/10 dark:text-red-300">Out</span>}
                                                                    </div>

                                                                    <div>
                                                                        <p className="text-[10px] font-black uppercase tracking-[0.14em] text-slate-500 md:hidden">Warehouse</p>
                                                                        {v.wholesaleStock > 0
                                                                            ? <span className="inline-flex min-w-[3.4rem] justify-center rounded-full bg-amber-50 px-3 py-1 text-xs font-black text-amber-700 dark:bg-amber-500/12 dark:text-amber-300">{v.wholesaleStock}</span>
                                                                            : <span className="inline-flex justify-center rounded-full bg-red-50 px-3 py-1 text-[10px] font-black uppercase tracking-wider text-red-600 dark:bg-red-500/10 dark:text-red-300">Out</span>}
                                                                    </div>

                                                                    <div>
                                                                        <p className="text-[10px] font-black uppercase tracking-[0.14em] text-slate-500 md:hidden">Status</p>
                                                                        <span className={'inline-flex rounded-full px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.14em] ' + (v.linked ? 'bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-400' : 'bg-slate-200 text-slate-600 dark:bg-slate-500/10 dark:text-slate-400')}>
